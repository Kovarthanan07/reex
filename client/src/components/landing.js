    ...
    <div className="container">
      <Grid container style={{ minHeight: ""}}>
        ...
        <div>
          ...
          <img src={Iconimg} alt="logo" width={100} height={80} style={{margin: 10}}  />
        {/* </Grid> */}
        <div style={{marginBottom: 160, marginTop: 60}}>
          <p style={{fontSize: 35}}><b>Welcome to</b></p>
          <p style={{fontSize: 35}}><b>Recipt & Expense Managment System</b></p>
          <p style={{fontSize: 15}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the </p>
          {/* <button type="submit"
            fullWidth
            variant="contained"
        ...
        <div>
        <Grid container justify='center'>
         <img className="container" src={Chart} alt="logo" width={450} height={500} />
        </Grid>
        </div>
        <div/>
        </Grid>
