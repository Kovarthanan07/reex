        ...
        <div className="container">
          <Paper elevation={4} style={{ padding: '20px' }}>
            ...
            <form autoComplete="off" onSubmit={formik.handleSubmit}>
                ...
                <Col xs={12} sm={4}>
                  <div className="form-group">
                    ...
                    {formik.errors.startDisplayOn ? (
                      <div className="text-danger">{formik.errors.startDisplayOn}</div>
                    ) : null}
                  </div>
                </Col>
                <Col xs={12} sm={4}>
                  <div className="form-group">
                    ...
                    {formik.errors.endDisplayOn ? (
                      <div className="text-danger">{formik.errors.endDisplayOn}</div>
                    ) : null}
                  </div>
                </Col>
                <Col>
                  <div className="form-group">
                    <Label for="newsImage">Upload News Cover</Label>
                    <Input
                      type="file"
                      name="profileImg"
                      onChange={formik.handleChange}
              ...
              <button className="btn btn-primary">Post News <DoubleArrowSharpIcon/></button>
            </form>
          </Paper>
        </div>
      </Col>
